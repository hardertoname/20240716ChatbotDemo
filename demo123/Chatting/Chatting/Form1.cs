...
namespace Chatting
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            accesstoken = lion.ReadString("app", "accesstoken", "11111");
            //subject = lion.ReadString("app", "subject", "0");
            webBrowser1.DocumentText = contentHead.Replace("{subject}", "0").Replace("{color}", "#F3F3F3") ;
            // lion.IniWriteValue("app", "host", "http://127.0.0.1:7020");
            hostUrl = lion.ReadString("app", "host", "https://127.0.0.1:5058");
        }

     
        public string accesstoken = "11111";
       public string subject = "0";
        public string hostUrl = "https://127.0.0.1:5058";
...
api，  validation，authentication authorization, error handling, logging 
             */
